        ...
        <div className="container">
          <div className="row justify-content-center">
            <div className="col-lg-8 text-center">
              ...
              <p className="text-muted mb-5">Do you have any critique or suggestion for us? Feel freely to give us a call or send us an email!</p>
            </div>
          </div>
          <div className="row">
      ...
      <footer className="bg-dark mt-5 py-5">
        <div className="container mt-0">
          <div className="row d-flex justify-content-center mt-0 mb-1">
            ...
            {/* <div className="col-lg-4 text-center mb-lg-0"> */}
          ...
          <div className="row d-flex justify-content-center">
            ...
            <div className="col-lg-4 mb-lg-0">
              <div className="small text-center text-muted">Copyright © 2020 - BREADCRUMB</div>
            </div>
          </div>
        </div>
      </footer>
