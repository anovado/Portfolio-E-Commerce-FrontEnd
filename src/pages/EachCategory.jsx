...
import { handleRequestCategory, getRes, getProductData, getProductsByCategory } from "../store/actions/actionProduct";
          ...
          <div className="row">
            {allProductsData.map((el, index) => (
              <div className="col-lg-4 mt-3">
                <ProductFrame name={el.name} image={el.image} id={el.id} handleRouter={(e) => this.handleRequestCategoryProducts(e)} />
              </div>
            ))}
          </div>
        </div>
